...
| 篇目 | 主题 |
|------|------|
| 一 | [AgentScope Java 入门：用 Java 构建生产级 AI 智能体的全新范式](https://smartsi.blog.csdn.net/article/details/158778778) |
| 二 | [Spring AI Alibaba 与 AgentScope 的定位与区别](https://smartsi.blog.csdn.net/article/details/160955593) |
| 三 | [AgentScope Java 入门：如何安装 AgentScope](https://smartsi.blog.csdn.net/article/details/160694030) |
| **四（本文）** | **搭建第一个 ReAct 智能体** |
