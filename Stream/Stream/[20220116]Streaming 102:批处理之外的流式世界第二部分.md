...
欢迎回来！如果你错过了我之前的博文：[批次之外的世界：流式传输 101]()，我强烈建议您花时间先阅读该帖子。它为我将在这篇文章中介绍的主题奠定了必要的基础，并且我假设你已经熟悉其中介绍的术语和概念。警告讲师和所有这些。

另外，请注意，这篇文章包含许多动画，所以那些尝试打印它的人会错过一些最好的部分。警告打印机等等。

免责声明，让我们开始这个派对。简单回顾一下，上次我主要关注三个主要领域：术语，当我使用“流媒体”等重载术语时准确定义我的意思；批处理与流式比较，比较这两种系统的理论能力，并假设只有两件事才能使流式系统超越批处理系统：正确性和时间推理工具；和数据处理模式，着眼于处理有界和无界数据时批处理和流式系统所采用的基本方法。
