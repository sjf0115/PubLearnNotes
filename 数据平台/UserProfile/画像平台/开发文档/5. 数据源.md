...
INSERT INTO `profile_meta_datasource` (`status`, `datasource_id`, `datasource_name`, `datasource_desc`, `schema_id`, `source_type`, `config`, `owner`, `creator`, `modifier`)
VALUES (1, '0500000000000002', 'hive-profile-dw', 'Hive用户画像数仓', '0400000000000002', 2, '{"host":"localhost","port":"3306","database":"profile","user_name":"","password":"", "driver": ""}', '100000', '100000', '100000');
```
