...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-1.png?raw=true)
图 1 . 堆内和堆外内存示意图
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-2.png?raw=true)
图 2 . 静态内存管理图示——堆内
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-3.png?raw=true)
图 3 . 静态内存管理图示——堆外
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-4.png?raw=true)
图 4 . 统一内存管理图示——堆内

![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-5.png?raw=true)
图 5 . 统一内存管理图示——堆外
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-6.png?raw=true)
图 6 . 动态占用机制图示
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-7.png?raw=true)
图 7 . Storage 模块示意图
...
![](https://github.com/sjf0115/PubLearnNotes/blob/master/image/Spark/spark-internal-memory-management-8.png?raw=true)
...
- [Spark Sort Based Shuffle 内存分析](https://www.jianshu.com/p/c83bb237caa8)
- [Spark OFF_HEAP](https://www.jianshu.com/p/c6f6d4071560)
- [Unified Memory Management in Spark 1.6](https://issues.apache.org/jira/secure/attachment/12765646/unified-memory-management-spark-10000.pdf)
- [Tuning Spark: Garbage Collection Tuning](http://spark.apache.org/docs/latest/tuning.html#garbage-collection-tuning)
- [Spark Architecture](https://0x0fff.com/spark-architecture/)
- [《Spark 技术内幕：深入解析 Spark 内核架构于实现原理》第 8 章 Storage 模块详解](https://book.douban.com/subject/26649141/)
- [Spark Sort Based Shuffle 内存分析](http://www.jianshu.com/p/c83bb237caa8)
...
- [探索  Spark Tungsten  的秘密](https://github.com/hustnn/TungstenSecret/tree/master)
- [Spark Task 内存管理（on-heap&off-heap）](http://www.jianshu.com/p/8f9ed2d58a26)
