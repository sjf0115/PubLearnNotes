...
进入 SeaTunnel [下载页面](https://seatunnel.apache.org/download)下载最新版本的发布版安装包 `seatunnel-<version>-bin.tar.gz`，目前最新版本为 2.3.13 版本：
...
将下载的压缩包解压缩到指定目录下：
```
tar -zxvf apache-seatunnel-2.3.13-bin.tar.gz -C /opt/workspace
```
创建软连接，便于升级：
```
ln -s apache-seatunnel-2.3.13/ seatunnel
```
设置 SeaTunnel 环境变量：
```
# SeaTunnel
...
# connector default version is 2.3.13, you can also choose a custom version. eg: 2.1.2:  sh install-plugin.sh 2.1.2
version=2.3.13
...
-rw-r--r--   1 wy  wheel   30540348 Jul 20 19:39 connector-cdc-mysql-2.3.13.jar
-rw-r--r--   1 wy  wheel   30830325 Jul 20 19:39 connector-clickhouse-2.3.13.jar
-rw-r--r--   1 wy  wheel      77830 Nov  9  2023 connector-console-2.3.13.jar
-rw-r--r--   1 wy  wheel   11785663 Jul 20 19:39 connector-doris-2.3.13.jar
-rw-r--r--   1 wy  wheel     199577 Nov  9  2023 connector-fake-2.3.13.jar
-rw-r--r--   1 wy  wheel   42296458 Jul 20 19:39 connector-file-hadoop-2.3.13.jar
-rw-r--r--   1 wy  wheel   42318873 Jul 20 19:39 connector-hive-2.3.13.jar
-rw-r--r--   1 wy  wheel  157677173 Jul 20 19:41 connector-hudi-2.3.13.jar
-rw-r--r--   1 wy  wheel   30625934 Jul 20 19:42 connector-iceberg-2.3.13.jar
-rw-r--r--   1 wy  wheel     776369 Jul 20 19:42 connector-jdbc-2.3.13.jar
-rw-r--r--   1 wy  wheel   17276586 Jul 20 19:43 connector-kafka-2.3.13.jar
-rw-r--r--   1 wy  wheel    1372145 Jul 20 19:43 connector-redis-2.3.13.jar
