...
运行命令:
```
flink run -c com.flink.example.table.function.windows.GroupWindowSQLExample /Users/wy/study/code/data-example/flink-example/target/flink-example-1.0.jar
```
