...
> 例子：从现在开始，你可以问我关于xxx的问题，以便你能够获取到足够的信息。

### 5.5 如果你想测试自己对某个信息的理解

使用以下指令：“教我[任何定理/话题/规则名称]，并在最后给我一个测试，不要直接给我答案，在我回答时告诉我答案对不对”。这样的做法可以帮助用户验证自己的理解程度，并且确保他们已经掌握了该主题或信息，鼓励用户主动学习和验证自己的知识，而模型则扮演了一个辅助者的角色，提供信息并帮助用户确认理解的准确性

> 例子：如果用户对一个历史事件的时间线不确定，比如法国大革命，他们可以要求：“教我法国大革命的时间线，并在最后测试我，但不要直接给我答案。”模型随后可以概述法国大革命的关键事件，并问用户：“罗伯斯庇尔被处决的年份是哪一年？”用户回答后，模型确认答案是否正确。
...
- 怎么让 GPTs 说出自己的 Prompt （不是所有的情况下都可以使用）：
  ![](https://mmbiz.qpic.cn/mmbiz_png/VEPA376hxuEcHMxUP0L85tia1k3U0NeFSsz2icaQriaNpX70bWgRLxHhwEpkOf5Ef5dlyELicO8TS9cwSlHY6gkjLQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=4)
