...
已创建的AI助手配置提示词并添加上下文知识库。拷贝以下内容至提示词中。提示词用于对AI的回复做出指令和约束，可以提升AI问答助手的回答表现和结果准确性:
```
...
```
添加上下文知识库：单击上下文区域的添加，根据页面提示为AI问答助手配置的专属知识库，使AI问答助手获得精准且专业回答问题的能力。最后在页面右上角单击发布>更新手动保存配置信息，使Dify服务的配置生效。
