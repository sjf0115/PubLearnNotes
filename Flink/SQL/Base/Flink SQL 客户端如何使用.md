...
![](img-flink-sql-client-2.jpg)

![](img-flink-sql-client-3.png)
...
![](img-flink-sql-client-7.png)

欢迎关注我的公众号和博客：

![](img-Other/smartsi.jpg)

原文：[SQL Client](https://ci.apache.org/projects/flink-docs-release-1.13/docs/dev/table/sqlclient/)
