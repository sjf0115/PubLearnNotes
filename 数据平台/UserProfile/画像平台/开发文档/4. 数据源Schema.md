...
初始化内置 JDBC 数据源 Schema：
```sql
INSERT INTO `profile_meta_datasource_schema` (`status`, `schema_id`, `schema_name`, `schema_type`, `jdbc_protocol`, `source_type`, `config_template`, `creator`, `modifier`)
VALUES (1, '0400000000000001', 'MySQL', '3', 'jdbc://mysql', 1, '[{"show_name":"Host","key":"host","value":"请输入","required":1,"encrypt":0,"tip":""},{"show_name":"端口号","key":"port","value":"3306","required":1,"encrypt":0,"tip":"port"},{"show_name":"数据库","key":"database","value":"请输入","required":1,"encrypt":0,"tip":"此处填写的数据库是导入或者导出的数据库"},{"show_name":"用户名","key":"user","value":"请输入","required":1,"encrypt":0,"tip":""},{"show_name":"密码","key":"password","value":"请输入","required":1,"encrypt":1,"tip":""},{"show_name":"驱动","key":"driver","value":"请输入","required":1,"encrypt":0,"tip":"JDBC 驱动"}]', '100000', '100000');


INSERT INTO `profile_meta_datasource_schema` (`status`, `schema_id`, `schema_name`, `schema_type`, `jdbc_protocol`, `source_type`, `config_template`, `creator`, `modifier`)
VALUES (1, '0400000000000002', 'Hive', '3', 'jdbc:hive2', 1, '[{"show_name":"Host","key":"host","value":"请输入","required":1,"encrypt":0,"tip":""},{"show_name":"端口号","key":"port","value":"3306","required":1,"encrypt":0,"tip":"port"},{"show_name":"数据库","key":"database","value":"请输入","required":1,"encrypt":0,"tip":"此处填写的数据库是导入或者导出的数据库"},{"show_name":"用户名","key":"user","value":"请输入","required":1,"encrypt":0,"tip":""},{"show_name":"密码","key":"password","value":"请输入","required":1,"encrypt":1,"tip":""},{"show_name":"驱动","key":"driver","value":"请输入","required":1,"encrypt":0,"tip":"JDBC 驱动"}]', '100000', '100000');

INSERT INTO `profile_meta_datasource_schema` (`status`, `schema_id`, `schema_name`, `schema_type`, `jdbc_protocol`, `source_type`, `config_template`, `creator`, `modifier`)
VALUES (1, '0400000000000003', 'MinIO', '3', '', 1, '[{"show_name":"Endpoint‌","key":"endpoint","value":"http://localhost:8000","tip":"MinIO服务的访问地址","componentName":"Input","required":1},{"show_name":"AccessKey ID‌","key":"ak","value":"","tip":"","componentName":"Input","required":1},{"show_name":"AccessKey Secret‌","key":"sk","value":"","tip":"","componentName":"Input","required":1},{"show_name":"Bucket Name","key":"bucket","value":"","tip":"MinIO Bucket 名称","componentName":"Input","required":1}]', '100000', '100000');
```
...
[
  ...
  {
    "show_name": "Bucket Name",
    "key": "bucket",
    "value": "MinIO Bucket 名称",
    "tip": "",
    "componentName": "Input",
    "required": 1
  }
